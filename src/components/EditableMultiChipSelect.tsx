...
interface EditableMultiChipSelectProps {
  category: string
...
export default function EditableMultiChipSelect({ category, defaultOptions, value, onChange, label }: EditableMultiChipSelectProps) {
        ...
        {editing && (
          <div className="flex items-center gap-1">
            <input
              ...
              placeholder="新增..."
              className="w-16 px-2 py-1 rounded-full border border-stone-200 dark:border-stone-600 bg-white dark:bg-stone-700 text-xs text-stone-700 dark:text-stone-200 outline-none focus:ring-1 focus:ring-coffee-500"
            />
            <button
              type="button"
              onClick={handleAdd}
              className="w-5 h-5 rounded-full bg-coffee-500 text-white flex items-center justify-center"
            >
              <svg viewBox="0 0 12 12" className="w-2.5 h-2.5" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round">
